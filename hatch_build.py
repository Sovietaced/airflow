...
DEPENDENCIES = [
    ...
    "methodtools>=0.4.7",
    "opentelemetry-api@git+https://github.com/Sovietaced/opentelemetry-python@protobuf5-test#subdirectory=opentelemetry-api",
    "opentelemetry-exporter-otlp@git+https://github.com/Sovietaced/opentelemetry-python@protobuf5-test#subdirectory=exporter/opentelemetry-exporter-otlp",
    "packaging>=14.0",
    "pathspec>=0.9.0",
    "pendulum>=2.1.2,<4.0",
    "pluggy>=1.0",
